...
def generate_buildings(zone_all, EGID_list, API_url, altitude_default=0,
                                 ...
                                 zone_floor=None, zone_roof=None, zone_wall=None, renov_window=False, renov_wall=False):
    ...
    for MO_index in zone_all.index:
        ...
        if Year_default_values == True: #by default, most recent building
            ...
            for year in dicts.THRESHOLDS.keys():
                if construction_period <= year:
                    ...
                    wall_type, roof_type, floor_type, Ninf, glazing_u_value, glazing_g_value, glazing_ratio = dicts.THRESHOLDS[construction_year]
                    if renov_window == True:
                        glazing_u_value = 1.2
                    if renov_wall == True:
                        wall_type = wall_type +10
        ...
        #William add habitable surface
        habitable_surface =n_floors*footprint.area*alpha_floor
        ...
        buildings.append( 
            ...
            'year':construction_year, 'area_person':area_person,'habitable_surface' :habitable_surface, 'foot_print_area' : footprint.area, 'n_floors' : n_floors,
