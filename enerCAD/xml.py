...
def add_surfaces(zone, envelope, center_coordinates, renov_wall=False):
    ...
    for r in envelope.index:
        ...
        if class_id == 33:
            ...
            #adding pv panels
            if row['is_north_facing'] :
                dict_pv = {"Etampref": "0.21", "Tcnoct": "45", "Tref": "25",
                "Vmp": "57.3", "muVoc": "-0.1674", "name": "SunPower X21-335-BLK",
                "pvRatio": "1.0"}
            
                pv = SubElement(surface, "PV", dict_pv)
...
def add_all_buildings(district, buildings, envelope, center_coordinates=(0,0), renov_wall = False):
    for i in buildings.index:
        ...
        add_surfaces(zone, e, center_coordinates, renov_wall)
